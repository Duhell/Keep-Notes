...
@section('content')
    <div class="relative w-full h-[100vh] md:flex md:justify-center md:items-center md:flex-col">
        ...
        <div class="bg-slate-200 p-5 rounded w-[300px]">
            <p class="text-center text-[1.3rem] font-semibold">Sign in</p>
            @if ($errors->any())
            ...
            <form action="{{ url('/') }}" method="post" class="mt-3">
                ...
                <div class="md:flex md:flex-col relative mb-2">
                    <input type="text" name="nickname" id="nickname" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 appearance-none focus:outline-none focus:ring-1 focus:border-blue-600 peer" placeholder=" " />
                ...
                <div class="md:flex md:flex-col relative">
                    <div class="md:flex md:flex-col relative">
                        <input type="password" name="password" id="password" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 appearance-none focus:outline-none focus:ring-1 focus:border-blue-600 peer" placeholder=" " />
                ...
                <div class="w-full h-full md:flex justify-center mt-4">
                    <button type="submit" class="text-white w-full bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Login</button>
                </div>
                <div>
                    <a href="{{ url('register') }}" class="inline-flex items-center font-medium text-blue-600 text-[.8rem] hover:underline">Create Account
